 <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
                     ...
                     <li class="active">
                        <a href="#dashboard1" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-files-o orange_color"></i> <span>Departamente</span></a>
                     ...
                     <li>
                        <a href="#element" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-users purple_color"></i> <span>Angajati</span></a>
                        <ul class="collapse list-unstyled" id="element">
                           <li><a href="add-employee.php">> <span>Add</span></a></li>
                           <li><a href="manage-employee.php">> <span>Manage</span></a></li>
                     ...
                     <li>
                        ...
                        <ul class="collapse list-unstyled" id="apps">
                           <li><a href="add-task.php">> <span>Add</span></a></li>
                           <li><a href="manage-task.php">> <span>Manage</span></a></li>
                     ...
                     <li class="active">
                        <a href="#additional_page" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"><i class="fa fa-clone yellow_color"></i> <span>Pagini</span></a>
                        <ul class="collapse list-unstyled" id="additional_page">
                           <li>
                              <a href="aboutus.php">> <span>(De adaugat)</span></a>
                           </li>
                           <li>
                              <a href="contactus.php">> <span>(De adaugat)</span></a>
                           </li>
                           
                        </ul>
                     </li>
                     <li><a href="search-employee.php"><i class="fa fa-map purple_color2"></i> <span>Cautare Angajati</span></a></li>
                     <li><a href="betweendates-task-report.php"><i class="fa fa-bar-chart-o green_color"></i> <span>Raport Task</span></a></li>
