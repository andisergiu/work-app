               ...
               <div class="login_section">
                  ...
                  <div class="login_form">
                     <form method="post" name="login">
                        <fieldset>
                           <div class="field">
                              <label class="label_field">ID Anagjat</label>
                              <input type="text" class="form-control" placeholder="adauga ID-ul de angajat" required="true" name="empid">
                           </div>
                           <div class="field">
                              <label class="label_field">Parola</label>
                              <input type="password" class="form-control" placeholder="adauga parola" name="password" required="true">
                           </div>
